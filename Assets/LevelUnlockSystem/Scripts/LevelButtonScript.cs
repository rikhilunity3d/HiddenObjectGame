...
namespace LevelUnlockSystem
{
    public class LevelButtonScript : MonoBehaviour
    {
        ...
        [SerializeField] private Image levelIndexText;               //ref to text which indicate the level number
        [SerializeField] private Image lockLevelIndexText;
        ...
        public void SetLevelButton(LevelItem value, int index, bool activeLevel)        
        {
            ...
            if (value.unlocked)                                     //if unlocked is true
            {
                ...
                levelIndexText.sprite = Resources.Load<Sprite>("LevelBackgrounds/" + levelIndex);//set levelIndexText text
            ...
            else
            {
                ...
                lockLevelIndexText.sprite = Resources.Load<Sprite>("LevelBackgrounds/" + levelIndex);//set levelIndexText text
            }
        }
