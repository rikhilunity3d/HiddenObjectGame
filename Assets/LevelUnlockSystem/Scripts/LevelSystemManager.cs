...
namespace LevelUnlockSystem
{
    public class LevelSystemManager : MonoBehaviour
    {
        ...
        }   //getter and setter for currentLevel
        ...
        public void LevelComplete(int starAchieved)                             //method called when player win the level
        {
            ...
            if (levelData.lastUnlockedLevel < (currentLevel + 1))
            {
                ...
                Debug.Log("Level Data Unlocked Level "+levelData.lastUnlockedLevel);

                Debug.Log("Level Data Length "+LevelData.levelItemArray.Length);
                //and make next level unlock true
                if (levelData.lastUnlockedLevel < LevelData.levelItemArray.Length)
                {
